          ...
          <div class='card-body p-4 p-md-4'>
            <div class='row g-3'>
              <div class='col-12 col-md-6'>
                ...
                <input id='toy-name-input' ref='nameInput' type='text' name='name' v-model='form.name' :disabled='savingToy'
                  placeholder="Enter a toy's name..." class='form-control' autocomplete='off' @input='clearFieldError("name")'
              ...
              <div class='col-12 col-md-6'>
                ...
                <input id='toy-image-input' type='text' name='image' v-model='form.image' :disabled='savingToy'
                  placeholder="Enter a toy's image URL..." class='form-control' autocomplete='off' @input='clearFieldError("image")'
                  :class="{ 'is-invalid': Boolean(validationErrors.image) }"
              ...
              <div class='col-12 toy-form-actions d-flex flex-column flex-md-row align-items-stretch align-items-md-center gap-2 gap-md-3'>
                <button type='submit' name='submit' class='btn btn-danger px-4 toy-form-submit' :disabled='savingToy'>
                  {{ savingToy ? 'Saving...' : 'Create New Toy' }}
                </button>
